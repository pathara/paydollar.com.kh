...
function includeCommon() {
  ...
  for (i = 0; i < z.length; i++) {
    ...
    file = elmnt.getAttribute("includeCommon");
    if (file) {
      ...
      xhttp.onreadystatechange = function() {
        if (this.readyState == 4) {
          ...
          elmnt.removeAttribute("includeCommon");
          includeHTML();
        }
      }
...
//End ---------------------------------------------
   ...
   document.addEventListener('DOMContentLoaded', function() {
    var menuButton = document.getElementById('showRightPush');
    var closeButton = document.querySelector('#mynav #showRightPush');
    var mobileMenu = document.getElementById('mynav');

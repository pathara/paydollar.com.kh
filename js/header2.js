...
$('.sales').attr('href', 'mailto:sales@xxx.com');
$('.sales').html('sales@xxx.com');
...
$('.about-f').html('PayDollar Cambodia is a payment gateway platform developed by AsiaPay Limited, a leading payment service provider in the Asia Pacific region, for the Indonesian e-commerce space. PayDollar Cambodia provides merchants with the facility to accept payments online through credit cards, internet banking and alternative payment methods such as BCA KlikPay, mandiri clickpay, and more.');
// Navigation Config //
// Menu1 //

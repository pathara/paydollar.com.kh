...
$('.sales').attr('href', 'mailto:sales@paydollar.com.kh');
$('.sales').html('sales@paydollar.com.kh');
$('.telno').html('+855 23 962 300');
$('.address').html('Phnom Penh, Canadia Bank Tower, 18/F Canadia Bank Tower, No. 315, Ang Doung St,, Corner Monivong Blve, Phnom Penh, 0, Cambodia ');
 ...
 */
$('.cryear').html('2021 PT AsiaPay Technology Indonesia | All Rights Reserved');
$('.country').html('Indonesia');
$('.about-f').html('PayDollar Cambodia is a payment gateway platform developed by AsiaPay Limited, a leading payment service provider in Asia Pacific, for the Cambodia e-commerce space. PayDollar Cambodia empowers merchants with a seamless and effortless solution to conveniently accept digital payments.');
// Navigation Config //
// Menu1 //
...
// Menu3 //
$('.mainMenu3').html('Value-Added Services');
